...
from .use_cases import CreateMetaWord, GetMetaWordsByType
...
@router.post("/meta_word", response_model=CreateMetaWordResponse, status_code=201)
...
@router.get("/meta_word/{word_type}", response_model=MetaWordsListResponse)
